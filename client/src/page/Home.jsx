    ...
    <main className='container py-4'>
      <section className='row'>
        ...
        <div className='col-md-4'>
          <Cart handleDecreaseQuantity={handleDecreaseQuantity} handleIncreaseQuantity={handleIncreaseQuantity} cart={cart} setCart={setCart} removeItem={removeItem} calcTotalPrice={calcTotalPrice} />
        </div>
      </section>
